...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1','custom'], help='name of dataset')
...
parser.add_argument('--loss', type=str, default='mae',help='loss function:mae,mse,mae_p,mae_sp') # cy!
...
# cy_addcode
parser.add_argument('--scaler_way', type=int, default=0, help='0:StandardScaler , 1:Max_Min_Scaler')
parser.add_argument('--data_custom', type=str, default='SSE_92.csv')
parser.add_argument('--target_custom', type=str, default='closeIndex')
parser.add_argument('--enc_in_custom', type=int, default=7, help='encoder input size')
parser.add_argument('--dec_in_custom', type=int, default=7, help='decoder input size')
parser.add_argument('--c_out_custom', type=int, default=7, help='output size')
...
#     cy 额外添加
    'custom': {'data': args.data_custom, 'T': args.target_custom, 'M': [args.enc_in_custom, args.dec_in_custom, args.c_out_custom], 'S': [args.enc_in_custom, args.dec_in_custom, args.c_out_custom], 'MS': [args.enc_in_custom, args.dec_in_custom, args.c_out_custom]},
}
